    ...
    rsx! {
        div {
            ...
            div {
                ...
                h2 {
                    style: "margin: 0 0 12px 0; color: #495057; font-size: 18px;",
                    "Meine Listen"
                }
                button {
                    style: "width: 100%; background-color: #28a745; color: white; border: none; padding: 10px; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 500;",
...
fn MainContent(app_state: Signal<AppState>) -> Element {
    rsx! {
        div {
            ...
            if let Some(index) = app_state.read().current_list_index {
                {
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    div {
                                        ...
                                        button {
                                            style: "background-color: #6c757d; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer; font-size: 14px;",
                                    ...
                                    div {
                                        style: "display: flex; flex-direction: column; gap: 8px;",
                                        {
                                            list.elements_buffer.iter().enumerate().map(|(element_index, element)| {
                                                ...
                                                let element_id_top = element_id.clone();
                                                let element_id_bottom = element_id.clone();

                                                rsx! {
                                                    div {
                                                        key: "{element.id}",
                                                        style: "background-color: white; border: 1px solid #dee2e6; border-radius: 8px; padding: 16px; display: flex; align-items: center; gap: 12px; transition: all 0.2s; hover: box-shadow: 0 2px 8px rgba(0,0,0,0.1);",
                                                        ...
                                                        div {
                                                            ...
                                                            if element_index > 0 {
                                                                button {
                                                                    ...
                                                                    onclick: move |_| app_state.write().move_element_to_top(&element_id_top),
                                                                    "⏫"
                                                                }
                                                            }
                                                            // Move one up
                                                            ...
                                                            if element_index < list.elements_buffer.len() - 1 {
                                                                button {
                                                                    ...
                                                                    onclick: move |_| app_state.write().move_element_to_bottom(&element_id_bottom),
                                                                    "⏬"
                                                                }
                                                            }
                                                            // Edit button
                                                            button {
                                                                style: "background: none; border: none; color: #6c757d; cursor: pointer; padding: 4px; border-radius: 4px; font-size: 14px; margin-left: 8px;",
                                                                title: "Bearbeiten",
            ...
            div {
                ...
                div {
                    ...
                    input {
                        ...
                        onkeypress: move |e| {
                            if e.key() == dioxus::prelude::Key::Enter && !app_state.read().new_list_name.trim().is_empty() {
                                app_state.write().create_new_list();
                            }
                        },
                    }
                }
            ...
            div {
                ...
                div {
                    ...
                    input {
                        ...
                        onkeypress: move |e| {
                            if e.key() == dioxus::prelude::Key::Enter && !app_state.read().new_element_name.trim().is_empty() {
                                app_state.write().add_element();
                            }
                        },
                    }
                }
            ...
            div {
                ...
                div {
                    ...
                    input {
                        ...
                        onkeypress: move |e| {
                            if e.key() == dioxus::prelude::Key::Enter && !app_state.read().edit_element_name.trim().is_empty() {
                                app_state.write().save_element_changes();
                            }
                        },
                    }
                }
    ...
    rsx! {
        div {
            ...
            onkeydown: move |e| {
                // Keyboard shortcuts
                match e.key() {
                    dioxus::prelude::Key::Character(c) if c == "n" && (e.data().modifiers().ctrl() || e.data().modifiers().meta()) => {
                        e.prevent_default();
                        app_state.write().show_new_list_dialog = true;
                    },
                    dioxus::prelude::Key::Escape => {
                        let mut state = app_state.write();
                        state.show_new_list_dialog = false;
                        state.show_add_element_dialog = false;
                        state.show_element_editor = false;
                    },
                    _ => {}
                }
            },
            ...
            div {
                ...
                div {
                    style: "color: #adb5bd; font-size: 12px; display: flex; gap: 16px;",
                    span { "Shortcuts:" }
                    span { "Ctrl+N: Neue Liste" }
                    span { "Ctrl+A: Neuer Eintrag" }
                    span { "ESC: Dialog schließen" }
                    span { "Enter: Bestätigen" }
                }
            }
