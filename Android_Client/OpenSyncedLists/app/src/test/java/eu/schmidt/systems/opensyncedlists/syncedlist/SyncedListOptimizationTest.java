...
public class SyncedListOptimizationTest
{
    ...
    @Test
    public void testFullOptimizationEmptyResult() throws JSONException
    {
    ...
    @Test
    public void testFullOptimizationWithElements() throws JSONException
    {
        SyncedList list = createListWithHostname("");
    ...
    @Test
    public void testFullOptimizationPreservesOrder() throws JSONException
    {
        SyncedList list = createListWithHostname("");
    ...
    @Test
    public void testFullOptimizationPreservesCheckedState() throws JSONException
    {
        SyncedList list = createListWithHostname("");
        ...
        list.addElementStep(new SyncedListStep("item1", ACTION.UPDATE, checked));
    ...
    @Test
    public void testSyncSupportedOptimizationKeepsAddRemove() throws JSONException
    {
    ...
    @Test
    public void testSyncSupportedOptimizationRemovesMoveSwap() throws JSONException
    {
        SyncedList list = createListWithHostname("localhost");
        ...
        // MOVE/SWAP are optimized: old ones removed, new MOVE steps added for current positions
    ...
    @Test
    public void testClearRemovesPreviousSteps() throws JSONException
    {
        SyncedList list = createListWithHostname("localhost");
        ...
        Assert.assertEquals(0, list.getElements().size());
        Assert.assertEquals(1, list.getElementSteps().size());
        Assert.assertEquals(ACTION.CLEAR, list.getElementSteps().get(0).getChangeAction());
    }
    ...
    @Test
    public void testOptimizationWithManyOperations() throws JSONException
    {
        SyncedList list = createListWithHostname("");
    ...
    @Test
    public void testOptimizationMaintainsConsistency() throws JSONException
    {
        SyncedList list = createListWithHostname("");
    ...
    @Test
    public void testFullOptimizationRemovesAllHistory() throws JSONException
    {
        SyncedList list = createListWithHostname("");
        ...
        Assert.assertEquals(1, list.getElementSteps().size());
        Assert.assertEquals(ACTION.ADD, list.getElementSteps().get(0).getChangeAction());
        Assert.assertEquals("Item 1 v3", list.getElements().get(0).getName());
    }

    @Test
    public void testSyncSupportedOptimizationKeepsUpdateHistory() throws JSONException
    {
        SyncedList list = createListWithHostname("localhost");
        ...
        {
            if (step.getChangeAction() == ACTION.ADD) addCount++;
            if (step.getChangeAction() == ACTION.UPDATE) updateCount++;
        }
    ...
    @Test
    public void testOptimizationWithSingleElement() throws JSONException
    {
        SyncedList list = createListWithHostname("");
    ...
    @Test
    public void testClearOptimizationRemovesAllPreviousSteps() throws JSONException
    {
        SyncedList list = createListWithHostname("localhost");
    ...
    @Test
    public void testOptimizationAfterManyMoveOperations() throws JSONException
    {
        SyncedList list = createListWithHostname("");
