...
/**
 * Tests for basic SyncedList operations (ADD, REMOVE, UPDATE, MOVE, SWAP,
 * CLEAR). For sync tests see SyncedListSyncTest. For optimization tests see
 * SyncedListOptimizationTest.
 */
...
public class SyncedListTest
{
    ...
    @Test public void testUpdatingElements() throws JSONException
    {
        ...
        Assert.assertEquals("Item 1 Updated",
            list.getElements().get(0).getName());
        Assert.assertEquals("Description Updated",
            list.getElements().get(0).getDescription());
    }
    
    // ========== UPDATE Tests ==========
    
    @Test public void testCheckingElements() throws JSONException
    {
        list.addElementStep(new SyncedListStep("item1", ACTION.ADD,
            new SyncedListElement("item1", "Item 1", "Description 1")));
        ...
        list.addElementStep(
            new SyncedListStep("item1", ACTION.UPDATE, checkedElement));
    ...
    {
        SyncedListElement checkedElement =
            new SyncedListElement("item1", "Item 1", "Description 1");
        checkedElement.setChecked(true);
        list.addElementStep(
            new SyncedListStep("item1", ACTION.ADD, checkedElement));
        ...
        list.addElementStep(
            new SyncedListStep("item1", ACTION.UPDATE, uncheckedElement));
    ...
    @Test public void testMovingElementToStart() throws JSONException
    {
        list.addElementStep(new SyncedListStep("item1", ACTION.ADD,
            new SyncedListElement("item1", "Item 1", "Description 1")));
        list.addElementStep(new SyncedListStep("item2", ACTION.ADD,
    ...
    @Test public void testSwappingAdjacentElements() throws JSONException
    {
        list.addElementStep(new SyncedListStep("item1", ACTION.ADD,
            new SyncedListElement("item1", "Item 1", "Description 1")));
        list.addElementStep(new SyncedListStep("item2", ACTION.ADD,
    ...
    @Test public void testGenerateUniqueElementId()
    {
    ...
    @Test public void testUpdateNonExistentElementAddsIt() throws JSONException
    {
        // UPDATE on non-existent element should add it (implementation
        // behavior)
        list.addElementStep(new SyncedListStep("item1", ACTION.UPDATE,
            new SyncedListElement("item1", "Item 1", "Description 1")));
    ...
    @Test public void testRemoveNonExistentElement() throws JSONException
    {
    ...
    @Test public void testMoveToInvalidPosition() throws JSONException
    {
    ...
    @Test public void testSwapWithNonExistentElement() throws JSONException
    {
        ...
        list.addElementStep(
            new SyncedListStep("item1", ACTION.SWAP, "nonexistent"));
    ...
    @Test public void testDoubleAddSameId() throws JSONException
    {
    ...
    @Test public void testReAddAfterRemove() throws JSONException
    {
        ...
        Assert.assertEquals(1, list.getElements().size());
        Assert.assertEquals("Item 1 Restored",
            list.getElements().get(0).getName());
    }
    
    @Test public void testSwapWithSelf() throws JSONException
    {
    ...
    @Test public void testMoveToSamePosition() throws JSONException
    {
    ...
    @Test public void testEmptyNameAndDescription() throws JSONException
    {
    ...
    @Test public void testSpecialCharactersInElementData() throws JSONException
    {
        ...
        Assert.assertEquals(specialDesc,
            list.getElements().get(0).getDescription());
    }
    
    @Test public void testMoveNonExistentElement() throws JSONException
    {
    ...
    @Test public void testMultipleClearOperations() throws JSONException
    {
        ...
        Assert.assertEquals(1,
            list.getElementSteps().size()); // Only last CLEAR
    }
    
    @Test public void testMoveToNegativePosition() throws JSONException
    {
