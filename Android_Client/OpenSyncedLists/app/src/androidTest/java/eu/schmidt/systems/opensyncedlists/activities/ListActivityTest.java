...
public class ListActivityTest {
        ...
        @Rule
        public ActivityScenarioRule<ListsActivity> activityRule = new ActivityScenarioRule<>(ListsActivity.class);
                ...
                return new TypeSafeMatcher<View>() {
                        ...
                        protected boolean matchesSafely(View view) {
                                if (!(view instanceof RecyclerView))
                                        return false;
                                RecyclerView.ViewHolder vh = ((RecyclerView) view)
        ...
        public void testElementOperationsAndBulkActions() {
                ...
                // ---- G: toggle-all ----
                addElement("Last");
                // Check "Last" by text (order after prior bulk ops is not guaranteed by
                // position).
                onView(withId(R.id.recyclerView))
                ...
                // Remaining 4 (were unchecked) are now checked → at positions 2-5 (isolator at
                // 1)
                onView(withId(R.id.recyclerView))
                                .check(matches(atPosition(0,
        ...
        public void testSearchAndMenuActions() {
                // Known start state for the jump-buttons toggle check in section E.
                ...
                // ---- E: List settings navigation + jump-buttons toggle ----
                // Leave overview mode (enabled in section B) so the normal element
                // layout (which contains the jump-button bar) is shown again.
                onView(withId(R.id.action_overview)).perform(click());
                ...
                // Enable "jump buttons" inside the Design subscreen.
